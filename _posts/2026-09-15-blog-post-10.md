...
The prior probability p(z_k = 1) = πₖ reflects how common component k is overall. The conditional probability $p(x \mid \theta) = \sum_{k} \pi_k \mathcal{N}(x \mid \mu_k, \Sigma_k)$ describes data from component k.
